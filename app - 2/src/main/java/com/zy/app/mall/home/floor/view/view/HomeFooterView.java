...
public class HomeFooterView extends LinearLayout {
    ...
    private void initFooter()
    {
        ...
        this.errView.setOnClickListener(new View.OnClickListener(){//f(this)
            @Override
        ...
        JDImageUtils.displayImage("res:///"+R.drawable.home_product_footview, this.endView);//2130839347
        ...
        localButton.setOnClickListener(new View.OnClickListener(){//g(this)
            @Override
            public void onClick(View v) {
                if (HomeFooterView.this.retryListener != null)
