...
/*        List<NavigationBar> localList = NavigationBarTable.a(0, -1);
    ...
    public final JumpEntry b(int paramInt)
    {
        JumpEntry localg = new JumpEntry();
        if ((this.e == null) || (this.e.size() <= 0))
        {
            localg.a(this.sharedPreferences.getBoolean("shared_faxian_isjump_Navigation", false));
            return localg;
        }
        Iterator localIterator = this.e.iterator();
        while (localIterator.hasNext())
        {
            NavigationButton localNavigationButton = (NavigationButton)localIterator.next();
            if (localNavigationButton.getIndex() != 2)
                continue;
            if (!TextUtils.isEmpty(localNavigationButton.getUrl()))
            {
                localg.a(localNavigationButton.getUrl());
                localg.a(true);
            }
            this.sharedPreferences.edit().putBoolean("shared_faxian_isjump_Navigation", localg.a()).commit();
            /**
             * smali代码这里没有继续循环了
             */
        }
                    ...
                    if (v4 != null) { //if-eqz v4, :cond_8
                        ...
                        if (!"0".equals(v2)) {    //if-nez v2, :cond_1
                            ...
                            if (v6 == v0) {//if-nez v2, :cond_2
                                ...
                                //:goto_1
                                JSONArrayProxy v11 = v4.getJSONArrayOrNull("navigationconfig");
    ...
    public static void c(int paramInt) {
        if (MyApplication.getInstance().getMainFrameActivity() != null) {
            MyApplication.getInstance().getMainFrameActivity().b.a(Integer.valueOf(paramInt));
            if (JDUntil.hasSmartBar())
                try {
                    MyApplication.getInstance().getMainFrameActivity().a(paramInt);
                } catch (Exception e) {
                    if (Log.D) ;
                    e.printStackTrace();
                }
    ...
    public static class _N implements Runnable {
        private NavigationOptHelper a;
        public _N(NavigationOptHelper helper){
            this.a = helper;
        }
        ...
        public void run() {
            ...
            JDHomeFragment.JDHomeTM homeTM = new JDHomeFragment.JDHomeTM();
            homeTM.setBundle(localBundle);
            ApplicationManager.a(homeTM);
        }
    }
    public static class _O implements Runnable {
        private int a;
        private NavigationOptHelper b;
        public _O(NavigationOptHelper helper, int paramInt){
            this.a = paramInt;
            this.b = helper;
        }
        @Override
        public void run() {
            ...
            Bundle localBundle = new Bundle();
            JDNewCategoryFragment.JDNewCategoryTM newCategoryTM = new JDNewCategoryFragment.JDNewCategoryTM();
            newCategoryTM.setBundle(localBundle);
            ApplicationManager.a(newCategoryTM);
        }
    }
    public static class _P implements Runnable {
        private NavigationOptHelper a;
        public _P(NavigationOptHelper helper){
            this.a = helper;
        }
        @Override
        public void run() {
            ...
            ApplicationManager.a(localJDShoppingCartTM);
        }
    }
    public static class _Q implements Runnable {
        private NavigationOptHelper a;
        public _Q(NavigationOptHelper helper){
            this.a = helper;
        }
        @Override
        public void run() {
            this.a.lastIndex = 2;
            Bundle localBundle = new Bundle();
            JumpEntry jumpEntry = this.a.b(2);
            if (jumpEntry.a())
            {
                JDMFragment.JDMM localJDMM = new JDMFragment.JDMM();
                localBundle.putString("url", jumpEntry.b());
                ...
                ApplicationManager.a(localJDMM);
                return;
            }
            JDFaxianFragment.JDFaxianTM jdFaxianTM = new JDFaxianFragment.JDFaxianTM();
            jdFaxianTM.setBundle(localBundle);
            ApplicationManager.a(jdFaxianTM);
        }
    }
    public static class _R implements Runnable {
        private NavigationOptHelper a;
        public _R(NavigationOptHelper helper){
            this.a = helper;
        }
        @Override
        public void run() {
            this.a.lastIndex = 4;
            Bundle localBundle = new Bundle();
            JDPersonalFragment.JDPersonalTM localx = new JDPersonalFragment.JDPersonalTM();
