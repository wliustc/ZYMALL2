 ...
 */
public class JSONArrayProxy extends JSONArray {
    ...
    public JSONArrayProxy(JSONArray paramJSONArray)
    {
    ...
    public JSONArrayProxy getJSONArray(int paramInt)
            throws JSONException
    {
        return new JSONArrayProxy(this.jsonArray.getJSONArray(paramInt));
    }

    public JSONArrayProxy getJSONArrayOrNull(int paramInt)
    {
        try
        {
            JSONArrayProxy localJSONArrayPoxy = new JSONArrayProxy(this.jsonArray.getJSONArray(paramInt));
